...
//		self_location.setOnClickListener(this);
	...
	public void setInfo(final MapObjectModel objectModel,final String theText)
	{
...
//					mp.release();
	...
	public void onClick(View paramView) {
		...
		case R.id.map_point_detail:
			...
			//			intent.putExtra("景区名称", objectModel.getCaption());
		...
		case R.id. map_audio_play:
			...
			// 0 可见 4 不可见（占用布局空间） 8可不见的（不占用布局空间）  
