...
import com.qms.tubu.fragment.account.PerfectionFragment;
...
import com.qms.tubu.fragment.recommend.RecommendFragment;
...
//						skip(R.id.perfection, bundle, false);
						return;
					}
				}
				switch (checkedId) {
...
//					DialogUtil.showDialog("正在开发中", MainActivity.this);
					Log.i("TAG", "景区地图");
					activity(ScenicMapActivity.class);
					break;
				case R.id.main_rb_foot_my:
				...
				case R.id.main_rb_foot_search:
					Log.i("TAG", "景区导航");
					activity(ScenicNavigationActivity.class);
//					DialogUtil.showDialog("正在开发中", MainActivity.this);
					break;
				default:
					break;
	...
	public void skip(int id, @Nullable Bundle bundle,boolean isFirst) {
		...
		case R.id.my_map:
			...
			break;
		case R.id.perfection:
			fragment = new PerfectionFragment();
			break;
		case R.id.recommend:
